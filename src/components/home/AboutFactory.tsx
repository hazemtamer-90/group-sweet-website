      ...
      <div className="mx-auto grid max-w-7xl items-center gap-16 px-5 lg:grid-cols-2">
        ...
        <div className="relative order-2 lg:order-1">
          ...
          <div className="absolute right-4 top-4 rounded-3xl border border-[rgba(139,90,43,0.15)] bg-white p-5 text-center shadow-xl">
            ...
            <div className="mx-auto mb-3 flex h-10 w-10 items-center justify-center rounded-full bg-[#C9942A]">
            ...
            <div className="text-3xl font-bold text-[#670047]">
        ...
        <div className="order-1 lg:order-2"><div className="mb-4 inline-flex items-center gap-2 text-sm text-[#C9942A]">
...
<div className="flex flex-wrap items-center gap-6 border-t border-[rgba(139,90,43,0.15)] pt-6">
  ...
  {t.raw("badges").map(
    (badge: { label: string }, index: number) => {
